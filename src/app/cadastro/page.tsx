      ...
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
        ...
        <form onSubmit={handleCadastro} className="space-y-4">
          <div>
            ...
            <input id="nome" type="text" value={nome} onChange={(e) => setNome(e.target.value)} className="mt-1 w-full rounded-md border border-gray-300 p-3 text-gray-800 shadow-sm" required />
          </div>
          <div>
          ...
          <div>
            ...
            <input id="telefone" type="tel" placeholder="(XX) XXXXX-XXXX" value={telefone} onChange={(e) => setTelefone(e.target.value)} className="mt-1 w-full rounded-md border border-gray-300 p-3 text-gray-800 shadow-sm" required />
          </div>
          <div>
